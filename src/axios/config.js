...
export const rootURL = isDev ? (isMock ? '/mock' : isTest ? '/test' : '/') : '';

// 以下3个“环境变量”用于部署后的判断
export const isDevEnvironment = /campus.dev.163/g.test(window.location.href);
export const isTestEnvironment = /campus-test.163/g.test(window.location.href);
export const isProductEnvironment = /campus.163/g.test(window.location.href);
